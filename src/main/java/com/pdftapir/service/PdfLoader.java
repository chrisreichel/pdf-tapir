 ...
 * pdf-tapir annotations from the private hybrid package written by
 * {@link PdfSaver}.
 * <p>
 * For PDFs saved by older versions, the loader still recognises legacy PDF
 * annotation objects by their embedded tags:
 * <ul>
 *   <li>Text annotations: {@link PDAnnotationFreeText} with subject {@code "pdf-tapir-text"}</li>
 *   <li>Checkbox annotations: {@link PDAnnotationWidget} with annotation name {@code "pdf-tapir-checkbox"}</li>
 *   <li>Image annotations: {@link PDAnnotationRubberStamp} with subject {@code "pdf-tapir-image"}</li>
 * </ul>
 */
public class PdfLoader {
    ...
    private void restoreImageData(PDAnnotationRubberStamp stamp, ImageAnnotation ia) {
        ...
        String b64 = stamp.getCOSObject().getString(COSName.getPDFName("PETapirImgData"));
